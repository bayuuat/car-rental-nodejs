    ...
    <div class="col-12 col-xl-4">
        <div class="card h-100">
            ...
            <div class="card-body mt-4 d-flex flex-column" style="padding: 0">
                ...
                <span class="fw-light text-secondary mb-2"><i class="bi bi-people me-1"></i> ${
                  this.capacity
                } orang</span>
                <span class="fw-light text-secondary mb-2"><i class="bi bi-gear me-1"></i> ${
                  this.transmission
                }</span>
                <span class="fw-light text-secondary mb-4"><i class="bi bi-calendar me-1"></i> Tahun ${
                  this.year
                }</span>
                <a href="#" class="mt-auto btn btn-primary w-100" ${
